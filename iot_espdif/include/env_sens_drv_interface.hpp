...
public:
    ...
    virtual return_code readTemperature(int32_t &temperature)
    {
        return not_supported;
    }
    
    virtual return_code readHumidity(uint32_t &humidity)
    {
        return not_supported;
    }

    virtual return_code readPressure(uint32_t &pressure)
    {
        return not_supported;
    }
